...
Revision ID: 5e3cc41fdce5
Revises: 
Create Date: 2025-10-17 15:43:46.721324
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['client_name'], ['clients.username'], ondelete='CASCADE'),
