...
describe("ApiClient - Live API Tests", () => {
  ...
  describe("setApiUrl", () => {
    it(
      "should return true for a valid API URL",
      async () => {
    ...
    it(
      "should return false for invalid API URL",
      async () => {
  ...
  describe("request methods with live API", () => {
    ...
    describe("GET requests", () => {
      it(
        "should successfully make a GET request to root endpoint",
        async () => {
      ...
      it(
        "should return an error for a non-existent endpoint",
        async () => {
          const response = await apiClient.get<RootResponse>(
    ...
    describe("POST requests", () => {
      ...
      describe("User Registration", () => {
        ...
        it(
          "should return 409 error for duplicate username",
          async () => {
            // First registration
            await apiClient.post<UserRegisterRequest, BasicTaskResponse>(
              "/user/auth/register",
              testUser,
            );
        ...
        it(
          ...
          async () => {
            ...
            const response = await apiClient.post<
              ...
              ApiError
            >("/user/auth/register", invalidUser);
      ...
      describe("User Login", () => {
        ...
        it(
          "should return 401 error for invalid username",
          async () => {
            const invalidUser = {
              username: "nonexistentuser",
              password: loginUser.password,
            };
            const response = await apiClient.post<UserLoginRequest, ApiError>(
              "/user/auth/login",
              invalidUser,
            );
        ...
        it(
          "should return 401 error for invalid password",
          async () => {
            const invalidUser = {
      ...
      describe("User Logout", () => {
        ...
        it(
          "should logout even without being logged in",
          async () => {
            const response = await apiClient.post<
              Record<string, never>,
              BasicTaskResponse
      ...
      describe("Authentication Flow", () => {
        ...
        it(
          "should complete full authentication flow: register -> login -> logout",
          async () => {
            // Register
            const registerResponse = await apiClient.post<
              UserRegisterRequest,
              BasicTaskResponse
            >("/user/auth/register", flowUser);
      ...
      describe("Error Handling", () => {
        it(
          ...
          async () => {
            ...
            const response = await apiClient.post<string, ApiError>(
              "/user/auth/register",
              "invalid-json",
            );
        ...
        it(
          "should return 404 for non-existent auth endpoint",
          async () => {
            const response = await apiClient.post<
              Record<string, never>,
              ApiError
            >("/user/auth/nonexistent", {});
            expect(response).toHaveProperty("statusCode", 404);
          },
          TIMEOUT,
        );
