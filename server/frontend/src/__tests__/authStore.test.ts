...
describe('AuthStore Tests', () => {
  ...
  describe('setUser', () => {
    it('should set user and authenticate when valid user is provided', () => {
    ...
    it('should update user when different user is set', () => {
  ...
  describe('clearUser', () => {
    ...
    it('should clear user multiple times without error', () => {
      const testUser = { username: 'testuser123' };
  ...
  describe('Authentication Flow', () => {
    it('should complete full authentication flow: login -> logout', () => {
  ...
  describe('Persistence', () => {
    it('should persist user data to localStorage when user is set', () => {
    ...
    it('should persist cleared state to localStorage when user is cleared', () => {
    ...
    it('should restore user state from localStorage on store initialization', () => {
  ...
  describe('Error Handling', () => {
    it('should handle undefined user gracefully', () => {
      expect(() => {
        useAuthStore.getState().setUser(undefined as unknown as { username: string });
      }).not.toThrow();
    }, TIMEOUT);

    it('should handle null user gracefully', () => {
      expect(() => {
        useAuthStore.getState().setUser(null as unknown as { username: string });
      }).not.toThrow();
    }, TIMEOUT);
