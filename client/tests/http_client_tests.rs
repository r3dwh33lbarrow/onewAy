...
mod tests {
    ...
    async fn test_root() {
        let api_client =
            ApiClient::new("http://127.0.0.1:8000/").expect("failed to create API client");
    ...
    async fn test_enroll_then_login() {
        ...
        let enroll_response = api_client
            .post::<ClientEnrollRequest, BasicTaskResponse>("/client/auth/enroll", &enrollment_data)
            .await
    ...
    async fn test_double_enroll() {
        ...
        let login_response_1 = api_client
            .post::<ClientEnrollRequest, BasicTaskResponse>(
                "/client/auth/enroll",
                &enrollment_data_1,
            )
            .await
        ...
        let login_response_2 = api_client
            .post::<ClientEnrollRequest, BasicTaskResponse>(
                "/client/auth/enroll",
                &enrollment_data_2,
            )
        ...
        assert!(
            login_response_2.is_err(),
            "Expected error on double enroll, but got Ok"
        );
    }
    ...
    async fn test_invalid_login() {
        ...
        assert!(
            ...
            "Expected error on invalid login, but got Ok"
        );
    }
    ...
    async fn test_access_token() {
        ...
        let refresh_response = api_client
    ...
    async fn test_username_check() {
        ...
        let check_response = api_client
            .get::<BasicTaskResponse>(&format!("/client/auth/{}/check", username))
            .await
    ...
    async fn test_username_mismatch() {
        ...
        let check_response = api_client
            .get::<BasicTaskResponse>("/client/auth/wrong_user/check")
            .await;
        assert!(
            check_response.is_err(),
            "Expected error on username mismatch, but got Ok"
        );
    }
}
